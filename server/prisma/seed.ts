...
async function main() {
  ...
  await prisma.store.createMany({
    data: [
      { name: "Trader Joe's - Saugus", location: "Saugus, MA" },
      { name: "Trader Joe's - Burlington", location: "Burlington, MA" },
      { name: "Trader Joe's - Arlington", location: "Arlington, MA" },
      { name: "Trader Joe's - Alewife", location: "Cambridge, MA" },
      { name: "Trader Joe's - Newton", location: "Newton, MA" },
      { name: "Trader Joe's - West Newton", location: "West Newton, MA" },
      { name: "Trader Joe's - Allston", location: "Allston, MA" },
      { name: "Trader Joe's - Cambridgeport", location: "Cambridge, MA" },
      { name: "Trader Joe's - Brookline", location: "Brookline, MA" },
      { name: "Trader Joe's - Back Bay", location: "Boston, MA" },
      { name: "Trader Joe's - Boylston", location: "Boston, MA" },
      { name: "Trader Joe's - Seaport", location: "Boston, MA" },
      { name: "Trader Joe's - Assembly", location: "Somerville, MA" },
    ],
  });
